...
%   sake of clarity, however this plot(shp, 'EdgeColor','none')would be of course more efficient.
%
% Author:
...
cIM = padarray(cIM,[maxDist maxDist maxDist],'both');
initPos = initPos+maxDist;
thresVal = double((max(max(max(cIM(initPos(1)-maxDist:initPos(1)+maxDist,initPos(2)-maxDist:initPos(2)+maxDist,initPos(3)-maxDist:initPos(3)+maxDist)))) - min(min(min(cIM(initPos(1)-maxDist:initPos(1)+maxDist,initPos(2)-maxDist:initPos(2)+maxDist,initPos(3)-maxDist:initPos(3)+maxDist)))))) * 0.2;
cIM = cIM(maxDist+1:end-maxDist,maxDist+1:end-maxDist,maxDist+1:end-maxDist);
initPos = initPos-maxDist;
